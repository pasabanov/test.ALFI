...
// 		_pade_checkbox = new QCheckBox("Pade Approximation");
...
// 			add_graph("Pade Approximation", xx, alfi::ratf::val(alfi::ratf::pade(alfi::poly::lagrange(X, Y), N / 2, N / 2), xx));
// 		}
...
int main(int argc, char* argv[]) {
	// std::cout << alfi::util::poly::mul({1, 2, 3}, {4, 5}) << '\n';
	// const std::vector<double> dividend = {1, -4, 4};
	// const std::vector<double> divisor = {1, -2};
	// const auto [quotient, remainder] = alfi::util::poly::div(dividend, divisor);
	// std::cout << "quotient: " << quotient << "\nremainder: " << remainder << '\n';
	{
		auto [r, s, t] = alfi::util::poly::extended_euclid({1, -3, 2}, {1, -1, -1, 1});
		std::cout << "r: " << r << "\ns: " << s << "\nt: " << t << '\n';
		std::cout << "================\n";
	}
	{
		auto [r, s, t] = alfi::util::poly::extended_euclid({1, 2, 3}, {1, 2});
		std::cout << "r: " << r << "\ns: " << s << "\nt: " << t << '\n';
		std::cout << "================\n";
	}
	{
		auto [r, s, t] = alfi::util::poly::extended_euclid({3, -1, -3, 2}, {1, 1, -1, -1, 1});
		std::cout << "r: " << r << "\ns: " << s << "\nt: " << t << '\n';
		std::cout << "================\n";
	}
	{
		auto [r, s, t] = alfi::util::poly::extended_euclid({}, {});
		std::cout << "r: " << r << "\ns: " << s << "\nt: " << t << '\n';
		std::cout << "================\n";
	}
	{
		auto [r, s, t] = alfi::util::poly::extended_euclid({}, {1});
		std::cout << "r: " << r << "\ns: " << s << "\nt: " << t << '\n';
		std::cout << "================\n";
	}
	{
	...
	{
		auto [r, s, t] = alfi::util::poly::extended_euclid({1}, {1});
		std::cout << "r: " << r << "\ns: " << s << "\nt: " << t << '\n';
		std::cout << "================\n";
	}
	return 0;
